...
% Run function
[xrv] = rvhistgen_sundman(mu, xrv0vec, 0, t);
...
% Plot Earth Orbit
xrvtrue = rvhistgen(thist',t1,xrv0vec,mu);
xrvtrue = xrvtrue';

% Run function
[xrv] = rvhistgen_sundman(mu, xrv0vec, t1, thist);
...
% Plot Earth Orbit
xrvtrue = rvhistgen(t2,0,x1,mu);
xrvtrue = xrvtrue';

% Run function
[xrv] = rvhistgen_sundman(mu, x1, 0, t2);
...
% Plot Earth Orbit
xrvtrue = rvhistgen(thist',0,x1,mu);
xrvtrue = xrvtrue';

% Run function
[xrv] = rvhistgen_sundman(mu, x1, 0, thist);
...
%% Output
fprintf('PASSED: Test_rvhistgen_sundman\n');