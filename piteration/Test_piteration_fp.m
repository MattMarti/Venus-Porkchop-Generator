...
%   http://www.dept.aoe.vt.edu/~cdhall/courses/aoe4134/Apiteration_fp.pdf
% 
% Test data from 
...
% 
% % Call Function
% [v1vec, v2vec] = piteration_fp(mu, r1vec, r2vec, tof, 1, 0, 0);
...
[v1, v2] = piteration_fp(mu, r1, r2, tof, ccwflag, hyperflag, plotflag);
...
%% Output
fprintf('PASSED: Test_piteration_fp\n');